...
--- task ---
Create a **Rotate** sprite button. To do this, select a **Button3** sprite once more.
...
--- task ---
Now, add code to the **Rotate** sprite so that it broadcasts a message when it is clicked:
